                ...
                if (ImageButtonChrome._commonHoverBorderOverlay == null)
                {
                    lock (ImageButtonChrome._resourceAccess)
                    {
                        if (ImageButtonChrome._commonHoverBorderOverlay == null)
                        {
                            ...
                            {
                                Thickness = 1.0,
                                Brush = new SolidColorBrush(Color.FromRgb(60, 127, 177))
                            };
                            pen.Freeze();
                ...
                if (ImageButtonChrome._commonPressedBorderOverlay == null)
                {
                    lock (ImageButtonChrome._resourceAccess)
                    {
                        if (ImageButtonChrome._commonPressedBorderOverlay == null)
                        {
                            ...
                            {
                                Thickness = 1.0,
                                Brush = new SolidColorBrush(Color.FromRgb(44, 98, 139))
                            };
                            pen.Freeze();
                ...
                if (ImageButtonChrome._commonDisabledBorderOverlay == null)
                {
                    lock (ImageButtonChrome._resourceAccess)
                    {
                        if (ImageButtonChrome._commonDisabledBorderOverlay == null)
                        {
                            ...
                            {
                                Thickness = 1.0,
                                Brush = new SolidColorBrush(Color.FromRgb(173, 178, 181))
                            };
                            pen.Freeze();
