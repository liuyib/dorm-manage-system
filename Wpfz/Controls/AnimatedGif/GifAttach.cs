...
{
    /// <summary>
    /// 通过为Image控件添加附加属性显示GIF动画。
    /// </summary>
    public static class GifAttach
    {
        ...
        public static ImageSource GetAnimatedSource(Image img)
        {
            return (ImageSource)img.GetValue(AnimatedSourceProperty);
        }
        public static void SetAnimatedSource(Image img, ImageSource value)
        {
            img.SetValue(AnimatedSourceProperty, value);
        }
        public static readonly DependencyProperty AnimatedSourceProperty = DependencyProperty.RegisterAttached(
              "AnimatedSource", typeof(ImageSource), typeof(GifAttach),
              new UIPropertyMetadata(null, AnimatedSourceChanged));
        #endregion //AnimatedSource
        ...
        public static readonly DependencyProperty RepeatBehaviorProperty = DependencyProperty.RegisterAttached(
              ...
              typeof(GifAttach),
              //new UIPropertyMetadata(default(RepeatBehavior), RepeatBehaviorChanged));
              new UIPropertyMetadata(RepeatBehavior.Forever, RepeatBehaviorChanged));
        ...
        public static readonly DependencyProperty AnimateInDesignModeProperty = DependencyProperty.RegisterAttached(
                "AnimateInDesignMode", typeof(bool), typeof(GifAttach),
        ...
        public static readonly DependencyProperty AutoStartProperty = DependencyProperty.RegisterAttached(
            "AutoStart", typeof(bool), typeof(GifAttach),
        ...
        private static readonly DependencyPropertyKey AnimationControllerPropertyKey = DependencyProperty.RegisterAttachedReadOnly(
            "AnimationController", typeof(ImageAnimationController),
            typeof(GifAttach), new PropertyMetadata(null));
        #endregion //AnimationController


        #region IsAnimationLoaded
        ...
        private static readonly DependencyPropertyKey IsAnimationLoadedPropertyKey = DependencyProperty.RegisterAttachedReadOnly(
            "IsAnimationLoaded", typeof(bool), typeof(GifAttach),
            new PropertyMetadata(false));
        public static readonly DependencyProperty IsAnimationLoadedProperty =
            IsAnimationLoadedPropertyKey.DependencyProperty;
        public static readonly RoutedEvent AnimationLoadedEvent = EventManager.RegisterRoutedEvent(
            "AnimationLoaded", RoutingStrategy.Bubble,
            typeof(RoutedEventHandler), typeof(GifAttach));
        #endregion //IsAnimationLoaded
        ...
        public static readonly RoutedEvent AnimationCompletedEvent = EventManager.RegisterRoutedEvent(
            "AnimationCompleted", RoutingStrategy.Bubble,
            typeof (RoutedEventHandler), typeof (GifAttach));
        ...
        /// <param name="d">The UIElement that listens to this event.</param>
        /// <param name="handler">The event handler to be removed.</param>
        public static void RemoveAnimationCompletedHandler(System.Windows.Controls.Image d, RoutedEventHandler handler)
        {
            if (!(d is UIElement element))
            {
                return;
        ...
        {
            if (!(sender is Image imageControl)) return;
        ...
        private static bool IsLoadingDeferred(BitmapSource source)
        {
            ...
            return bmp.UriSource != null && !bmp.UriSource.IsAbsoluteUri ? bmp.BaseUri == null : false;
        }
        ...
        private static RepeatBehavior GetActualRepeatBehavior(System.Windows.Controls.Image imageControl, BitmapDecoder decoder, GifFile gifMetadata)
        {
