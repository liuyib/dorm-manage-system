...
namespace Wpfz
{
    ...
    public class ImageAnimationController : IDisposable
    {
        ...
        {
            _sourceDescriptor = DependencyPropertyDescriptor.FromProperty(System.Windows.Controls.Image.SourceProperty, typeof (System.Windows.Controls.Image));
        }
        ...
        internal ImageAnimationController(System.Windows.Controls.Image image, ObjectAnimationUsingKeyFrames animation, bool autoStart)
        {
            _image = image;
        ...
        {
            _image.RaiseEvent(new System.Windows.RoutedEventArgs(GifAttach.AnimationCompletedEvent, _image));
        }
        ...
        protected virtual void Dispose(bool disposing)
        {
            if (disposing)
            {
                _image.BeginAnimation(System.Windows.Controls.Image.SourceProperty, null);
                _animation.Completed -= AnimationCompleted;
