...
namespace Wpfz.Docking.Controls
{
    public class NavigatorWindow : Window
    {
        ...
        internal void UpdateThemeResources(Wpfz.Docking.Themes.Theme oldTheme = null)
        {
            ...
            {
              if( _manager.Theme is Wpfz.Docking.Themes.DictionaryTheme )
              {
                currentThemeResourceDictionary = ( (Wpfz.Docking.Themes.DictionaryTheme )_manager.Theme ).ThemeResourceDictionary;
