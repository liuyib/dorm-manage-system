...
namespace Wpfz.Docking.Controls
{
    public abstract class LayoutFloatingWindowControl : Window, ILayoutControl
    {
      private ResourceDictionary currentThemeResourceDictionary; // = null
        ...
        internal virtual void UpdateThemeResources(Wpfz.Docking.Themes.Theme oldTheme = null)
        {
            if (oldTheme != null)
            {
            ...
            {
              if( manager.Theme is Wpfz.Docking.Themes.DictionaryTheme )
              {
                currentThemeResourceDictionary = ( (Wpfz.Docking.Themes.DictionaryTheme )manager.Theme ).ThemeResourceDictionary;
        ...
        void UpdateMaximizedState( bool isMaximized )
        {
          ...
          WindowState = isMaximized ? System.Windows.WindowState.Maximized : System.Windows.WindowState.Normal;
        }
