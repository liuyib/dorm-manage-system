...
namespace Wpfz.Docking.Layout
{
    ...
    public class LayoutAnchorSide : LayoutGroup<LayoutAnchorGroup>
    {
        ...
        {
            if (Root.LeftSide == this) Side = AnchorSide.Left;
            else if (Root.TopSide == this) Side = AnchorSide.Top;
            else if (Root.RightSide == this) Side = AnchorSide.Right;
            else if (Root.BottomSide == this) Side = AnchorSide.Bottom;
        }
