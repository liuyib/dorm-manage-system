...
namespace Wpfz.Docking
{
    ...
    public class DockingManager : Control, IOverlayWindowHost//, ILogicalChildrenContainer
    {
        ...
        static DockingManager()
        {
            ...
            FocusableProperty.OverrideMetadata(typeof(DockingManager),
      ...
      //  DispatcherOperation _setFocusAsyncOperation = null;
        ...
        /// indicates the strategy class to call when Wpfz.Docking needs to positionate a LayoutAnchorable inside an existing layout.
        /// </summary>
        ...
        internal UIElement CreateUIElementForModel(ILayoutElement model)
        {
            ...
            if (model is LayoutAnchorableFloatingWindow)
            {
                ...
                {
                  newFW.WindowState = System.Windows.WindowState.Maximized;
                }
                return newFW;
            }
        ...
        public static readonly DependencyProperty ThemeProperty =
            DependencyProperty.Register("Theme", typeof(Wpfz.Docking.Themes.Theme), typeof(DockingManager),
                new FrameworkPropertyMetadata(null,
                    new PropertyChangedCallback(OnThemeChanged)));

        /// <summary>
        /// Gets or sets the Theme property.  This dependency property 
        /// indicates the theme to use for Wpfz.Docking controls.
        /// </summary>
        public Wpfz.Docking.Themes.Theme Theme
        {
            get { return (Wpfz.Docking.Themes.Theme)GetValue(ThemeProperty); }
        ...
        {
            var oldTheme = e.OldValue as Wpfz.Docking.Themes.Theme;
            ResourceDictionary resources = this.Resources;
            if (oldTheme != null)
            {
              if( oldTheme is Wpfz.Docking.Themes.DictionaryTheme )
              {
            ...
            if (e.NewValue is Wpfz.Docking.Themes.Theme newTheme)
            {
                if (newTheme is Wpfz.Docking.Themes.DictionaryTheme)
                {
                    currentThemeResourceDictionary = ((Wpfz.Docking.Themes.DictionaryTheme)newTheme).ThemeResourceDictionary;
