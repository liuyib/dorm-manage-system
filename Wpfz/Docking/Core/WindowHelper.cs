...
namespace Wpfz.Docking
{
    static class WindowHelper
    {
        ...
        public static void SetParentToMainWindowOf(this Window window, Visual element)
        {
            ...
            if (wndParent != null) window.Owner = wndParent;
            else
            {
        ...
        {
            hwnd = IntPtr.Zero;
            if (!(PresentationSource.FromVisual(element) is HwndSource wpfHandle)) return false;
        ...
        {
            if (window.Owner != null) window.Owner = null;
            else
            {
